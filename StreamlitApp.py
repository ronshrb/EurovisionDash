...
if (2022 in selected_years_for_map) and (2021 in selected_years_for_map):
...
selected_countries = song_data[(song_data['year'] == selected_year) & ((song_data['qualified_10'] == '1') | (song_data['qualified_10'] == '-'))]['country'].unique()
